                    ...
                    <div class ="col-lg-12 well">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input path="undervisningstime.dato" name="dato" class="form-control" id="inputBruker" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01])-(0[1-9]|1[012])-[0-9]{4}" placeholder="dd-mm-����" required>
                            </div>
                        </div>
                         <div class="form-group">
